      ...
      <div className="my-8 md:my-14">
        <div className="w-full">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 order-1 md:order-1 overflow-hidden">
              <img 
                src={img} 
                alt={des}
            ...
            {/* Panel de texto */}
            <div
              className="w-full md:w-1/2 order-2 md:order-2 flex items-center justify-center py-8 px-8 md:py-8 md:px-12"
